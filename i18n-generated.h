...
// START I18N - automatically generated by pot2i18n.pl
  ...
  { "Error in timer settings",
    ...
    "Error en la configuraciÃ³n de la programaciÃ³n",
    "",
    "",
    "",
    "",
  ...
  { "Timers are being edited - try again later",
    ...
    "Las programaciones estÃ¡n siendo editadas - intÃ©ntelo de nuevo mÃ¡s tarde",
    "",
    "",
    "",
    "",
  ...
  { "Couldn't find recording or no recordings available.",
    ...
    "No se puede encontrar la grabaciÃ³n o grabaciones no disponibles",
    "",
    "",
    "",
    "",
  ...
  { "Not playing a recording.",
    ...
    "No se estÃ¡ reproduciendo una grabaciÃ³n",
    "",
    "",
    "",
    "",
  ...
  { "Not playing the same recording as from request.",
    ...
    "No se estÃ¡ reproduciendo la misma grabaciÃ³n que la solicitada",
    "",
    "",
    "",
    "",
  ...
  { "Attempt to delete recording currently in playback.",
    ...
    "Intentar borrar la grabaciÃ³n que se estÃ¡ reproduciendo",
    "",
    "",
    "",
    "",
  ...
  { "Channel has no schedule",
    ...
    "El canal no tiene programaciÃ³n",
    "",
    "",
    "",
    "",
  ...
  { "Required minimum version of epgsearch: ",
    ...
    "VersiÃ³n mÃ­nima de epgsearch requerida: ",
    "",
    "",
    "",
    "",
  ...
  { "EPGSearch version outdated! Please update.",
    ...
    "Â¡VersiÃ³n de EPGSearch antigua!. Por favor actualice",
    "",
    "",
    "",
    "",
  ...
  { "Couldn't aquire access to channels, please try again later.",
    ...
    "No se puede tener acceso a los canales, por favor intÃ©ntelo mÃ¡s tarde",
    "",
    "",
    "",
    "",
  ...
  { "Sorry, no permission. Please contact your administrator!",
    ...
    "Lo siento, no tiene permiso. Â¡Por favor contacte con su administrador!",
    "",
    "",
    "",
    "",
  ...
  { "Couldn't find recording. Maybe you mistyped your request?",
    ...
    "No se puede encontrar la grabaciÃ³n. Â¿Puede haberla escrito errÃ³neamente?",
    "",
    "",
    "",
    "",
  ...
  { "Please set a name for the recording!",
    ...
    "Â¡Por favor, introduzca un nombre para la grabaciÃ³n!",
    "",
    "",
    "",
    "",
  ...
  { "Cannot copy, rename or move the recording.",
    ...
    "No se puede copiar, renombre o mueva la grabaciÃ³n.",
    "",
    "",
    "",
    "",
  ...
  { "Delete resume information",
    ...
    "Borrar marcador de continuaciÃ³n",
    "",
    "",
    "",
    "",
  ...
  { "Delete marks information",
    ...
    "Borrar informaciÃ³n de marcadores",
    "",
    "",
    "",
    "",
  ...
  { "Couldn't find searchtimer. Maybe you mistyped your request?",
    ...
    "No se puede encontrar la programaciÃ³n. Â¿Puede que la haya escrito errÃ³neamente?",
    "",
    "",
    "",
    "",
  ...
  { "Edit search timer",
    ...
    "Editar la programaciÃ³n de bÃºsqueda",
    "",
    "",
    "",
    "",
  ...
  { "New search timer",
    ...
    "Nueva programaciÃ³n de bÃºsqueda",
    "",
    "",
    "",
    "",
  ...
  { "Search text too short - use anyway?",
    ...
    "Texto a buscar demasiado corto - Â¿usar de todos modos?",
    "",
    "",
    "",
    "",
  ...
  { "Match case",
    ...
    "Coincidir MayÃºscula/MinÃºscula",
    "",
    "",
    "",
    "",
  ...
  { "Use extended EPG info",
    ...
    "Usar informaciÃ³n EPG ampliada",
    "",
    "",
    "",
    "",
  ...
  { "When active this can cause very many timers. So please always first test this search before using it as search timer!",
    ...
    "Cuando se activa esta opciÃ³n se pueden producir muchas programaciones. Por lo tanto, haga el favor de testear siempre la programaciÃ³n de bÃºsqueda antes de usarla",
    "",
    "",
    "",
    "",
  ...
  { "The time the show may start at the latest",
    ...
    "La hora del programa puede comenzar despuÃ©s de",
    "",
    "",
    "",
    "",
  ...
  { "Use as search timer",
    ...
    "Aktywuj timer",
    "Usar como programador de bÃºsqueda",
    "",
    "",
    "",
    "",
  ...
  { "Delete recordings after ... days",
    ...
    "Borrar grabaciones despuÃ©s de ... dÃ­as",
    "",
    "",
    "",
    "",
  ...
  { "Only repeats within ... days",
    ...
    "Ãšnicamente repeticiones dentro de ... dÃ­as",
    "",
    "",
    "",
    "",
  ...
  { "Auto-delete search timer",
    ...
    "Borrado automÃ¡tico de la programaciÃ³n de bÃºsqueda",
    "",
    "",
    "",
    "",
  ...
  { "after ... days after first rec.",
    ...
    "tras ... dÃ­as despuÃ©s de la primera grabaciÃ³n",
    "",
    "",
    "",
    "",
  ...
  { "Please set a title for the timer!",
    ...
    "Â¡Por favor introduzca un tÃ­tulo para la programaciÃ³n!",
    "",
    "",
    "",
    "",
  ...
  { "Couldn't find user. Maybe you mistyped your request?",
    ...
    "No se puede encontrar el usuario. Â¿Puede que lo haya escrito errÃ³neamente?",
    "",
    "",
    "",
    "",
  ...
  { "This user name is already in use!",
    ...
    "Â¡Este nombre de usuario ya se estÃ¡ usando!",
    "",
    "",
    "",
    "",
  ...
  { "Add or edit timers",
    ...
    "AÃ±adir o editar programaciones",
    "",
    "",
    "",
    "",
  ...
  { "Start replay",
    ...
    "Iniciar de nuevo la reproducciÃ³n",
    "",
    "",
    "",
    "",
  ...
  { "Add or edit search timers",
    ...
    "AÃ±adir o editar programaciones de bÃºsqueda",
    "",
    "",
    "",
    "",
  ...
  { "Delete search timers",
    ...
    "Borrar programaciones de bÃºsqueda",
    "",
    "",
    "",
    "",
  ...
  { "Electronic program guide information",
    ...
    "Informacje EPG",
    "InformaciÃ³n de la GuÃ­a ElectrÃ³nica de ProgramaciÃ³n (EPG)",
    "",
    "",
    "",
    "",
  ...
  { "Couldn't find recording or no recordings available",
    ...
    "Tallennetta ei lÃ¶ydy tai yhtÃ¤Ã¤n tallennetta ei ole saatavilla.",
    "Nie mo¿na odnale¼æ nagrania",
    "No se puede encontrar la grabaciÃ³n o no hay programaciones disponibles",
    "",
    "",
    "",
    "",
  ...
  { "no epg info for current event!",
    ...
    "Â¡No hay informaciÃ³n de epg para este programa!",
    "",
    "",
    "",
    "",
  ...
  { "no epg info for current channel!",
    ...
    "Â¡no hay informaciÃ³n de epg para el canal actual!",
    "",
    "",
    "",
    "",
  ...
  { "error retrieving status info!",
    ...
    "error recibiendo la informaciÃ³n de estado",
    "",
    "",
    "",
    "",
  ...
  { "Wrong username or password",
    ...
    "Usuario o contraseÃ±a errÃ³neos",
    "",
    "",
    "",
    "",
  ...
  { "Find more at the Internet Movie Database.",
    ...
    "Hae IMDB:stÃ¤",
    "Szukaj w IMDb.com",
    "Encontrar mÃ¡s en la Base de Datos de PelÃ­culas de Internet",
    "",
    "",
    "",
    "",
  ...
  { "Stream this recording into browser.",
    ...
    "Reproduce esta grabaciÃ³n en el navegador",
    "",
    "",
    "",
    "",
  ...
  { "Failed to update infobox!",
    ...
    "Â¡La actualizaciÃ³n de infobox ha fallado!",
    "",
    "",
    "",
    "",
  ...
  { "If you encounter any bugs or would like to suggest new features, please use our bugtracker",
    ...
    "Si encuentra algÃºn bug o le gustarÃ­a sugerir nuevas caracterÃ­sticas, por favor use nuestro bugtracker",
    "",
    "",
    "",
    "",
  ...
  { "Look in recordings titles and subtitles for the given string and display only the matching ones. You may also use perl compatible regular expressions (PCRE).",
    ...
    "Buscar en grabaciones tÃ­tulos y subtÃ­tulos la cadena indicada y mostrar Ãºnicamente las que coincidan. Puede tambiÃ©n usar expresiones regulares tipo perl (PCRE).",
    "",
    "",
    "",
    "",
  ...
  { "Delete this recording from hard disc!",
    ...
    "Â¡Borrar esta grabaciÃ³n del disco duro!",
    "",
    "",
    "",
    "",
  ...
  { "Couldn't find channel or no channels available. Maybe you mistyped your request?",
    ...
    "Nie mo¿na odnale¶æ kana³u lub kana³y nie s± dostêpne.",
    "No se puede encontrar el canal o no hay canales disponibles. Â¿Puede que lo haya escrito de forma errÃ³nea?",
    "",
    "",
    "",
    "",
  ...
  { "Toggle search timer actions (in)active",
    ...
    "Cambiar acciones de la programaciÃ³n de bÃºsqueda (in)activo",
    "",
    "",
    "",
    "",
  ...
  { "Browse search timer results",
    ...
    "Navegar por los resultados de la bÃºsqueda",
    "",
    "",
    "",
    "",
  ...
  { "Delete this search timer?",
    ...
    "Borrar este programador de bÃºsqueda",
    "",
    "",
    "",
    "",
  ...
  { "Delete search timer",
    ...
    "Borrar programador de bÃºsqueda",
    "",
    "",
    "",
    "",
  ...
  { "Please set login and password!",
    ...
    "Por favor introduzca nombre de usuario y contraseÃ±a",
    "",
    "",
    "",
    "",
  ...
  { "Local net (no login required)",
    ...
    "Red local (sin autentificaciÃ³n requerida)",
    "",
    "",
    "",
    "",
  ...
  { "Show duration in 'Recordings'",
    ...
    "DuraciÃ³n del programa en 'Grabaciones'",
    "",
    "",
    "",
    "",
  ...
  { "Show dynamic VDR information box",
    ...
    "Mostrar informaciÃ³n dinÃ¡mica de VDR box",
    "",
    "",
    "",
    "",
  ...
  { "Additional fixed times in 'What's on?'",
    ...
    "Horas fijas adicionales en 'Â¿QuÃ© se emite ahora?'",
    "",
    "",
    "",
    "",
  ...
  { "Format is HH:MM. Separate multiple times with a semicolon",
    ...
    "El formato es HH:MM. Separado mÃºltiples veces con un punto y coma",
    "",
    "",
    "",
    "",
  ...
  { "Channel groups for MultiSchedule",
    ...
    "Grupos de canales para multi programaciÃ³n",
    "",
    "",
    "",
    "",
  ...
  { "Duration of MultiSchedule in hours",
    ...
    "DuraciÃ³n de la multi programaciÃ³n en horas",
    "",
    "",
    "",
    "",
  ...
  { "Timer has a conflict.",
    ...
    "La programaciÃ³n tiene un conflicto",
    "",
    "",
    "",
    "",
  ...
  { "Toggle timer active/inactive",
    ...
    "Cambiar programaciÃ³n activa/inactiva",
    "",
    "",
    "",
    "",
  ...
  { "Timer is recording.",
    ...
    "La programaciÃ³n se estÃ¡ grabando.",
    "",
    "",
    "",
    "",
  ...
  { "VLC: live video stream",
    ...
    "VLC: streamuj video",
    "VLC: reproducciÃ³n de vÃ­deo en vivo",
    "",
    "",
    "",
    "",
  ...
  { "View the schedule of this channel",
    ...
    "Ver la programaciÃ³n de este canal",
    "",
    "",
    "",
    "",
  ...
  { "No EPG information available",
    ...
    "Brak informacji EPG",
    "No hay informaciÃ³n disponible de la EPG",
    "",
    "",
    "",
    "",
